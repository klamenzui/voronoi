        ...
        while (!$a->checkpoint($b) || count($newborders) < 2) {
            ...
            if (($minId != $tmpborder->getId()) && ($tmpborder->getLength() > 0)) {
                ...
                if ($tmpborder->checkParaler($Ledge)) {
                    if(($Ledge=$this->addEdge($A,$B,$a,$keybord,$tmpborder,$newborders,$arr))==null) {
                        if(($Ledge = $this->addEdge($B,$A,$b,$keybord,$tmpborder,$newborders,$arr)) == null) {
                            if(($Ledge = $this->addEdge($A,$B,$b,$keybord,$tmpborder,$newborders,$arr)) == null) {
                                if (($Ledge = $this->addEdge($B,$A,$a,$keybord,$tmpborder,$newborders,$arr)) == null) {
                    ...
                    if(($Redge=$this->addEdge($A,$B,$a,$keybord,$tmpborder,$newborders,$arr))==null) {
                        if(($Redge = $this->addEdge($B,$A, $b,$keybord,$tmpborder,$newborders,$arr)) == null) {
                            if(($Redge = $this->addEdge($A,$B, $b,$keybord,$tmpborder,$newborders,$arr)) == null) {
                                if (($Redge = $this->addEdge($B,$A, $a,$keybord,$tmpborder,$newborders,$arr)) == null) {
                                    $arr = $this->cash($keybord,$tmpborder,$arr);
                                }else echo "R=B-a<br>";
                            }else echo "R=A-b<br>";
                        }else echo "R=B-b<br>";
